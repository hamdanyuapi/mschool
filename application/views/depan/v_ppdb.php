        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="mb-3">
                    ...
                    <select name="jenis_kelamin" class="form-select form-select-lg form-control" aria-label=".form-select-lg example">
                        <option value="laki_laki">Laki-laki</option>
                        <option value="peremepuan">Perempuan</option>
                    </select>
                </div>
            </div>
            <div class="col-lg-6">
            ...
            <div class="col-lg-6">
                <div class="mb-3">
                    ...
                    <input type="text" name="pekerjaan_ibu" class="form-control" id="alamat">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="mb-3">
